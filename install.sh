...
echo ""
info "Modules (12 total):"
printf "  %-32s %s\n" "AD/windows/winadsec"      "impacket, ldap3, zig, donut, xorriso, pyinstaller (+ nxc, kerbrute, bloodhound)"
...
printf "  %-32s %s\n" "network/wifi_monitor"     "aircrack-ng, hcxtools, hostapd, dnsmasq, reaver, hashcat"
printf "  %-32s %s\n" "network/iot_pwn"          "nmap, paramiko, requests (+ optional: snmpwalk, hydra)"
printf "  %-32s %s\n" "network/revshell"         "stdlib only — optional: nc, socat, msfvenom, nim"
...
printf "  %-32s %s\n" "phys/badusb"              "stdlib only (python3)"
